...
deque.$(OBJEXT): $(hdrdir)/ruby.h
deque.$(OBJEXT): $(hdrdir)/ruby/ruby.h
deque.$(OBJEXT): $(top_srcdir)/internal/array.h
deque.$(OBJEXT): $(top_srcdir)/internal/bignum.h
deque.$(OBJEXT): $(top_srcdir)/internal/bits.h
deque.$(OBJEXT): $(top_srcdir)/internal/compar.h
deque.$(OBJEXT): $(top_srcdir)/internal/compilers.h
deque.$(OBJEXT): $(top_srcdir)/internal/enum.h
deque.$(OBJEXT): $(top_srcdir)/internal/fixnum.h
deque.$(OBJEXT): $(top_srcdir)/internal/gc.h
deque.$(OBJEXT): $(top_srcdir)/internal/hash.h
deque.$(OBJEXT): $(top_srcdir)/internal/numeric.h
deque.$(OBJEXT): $(top_srcdir)/internal/object.h
deque.$(OBJEXT): $(top_srcdir)/internal/proc.h
deque.$(OBJEXT): $(top_srcdir)/internal/rational.h
deque.$(OBJEXT): $(top_srcdir)/internal/serial.h
deque.$(OBJEXT): $(top_srcdir)/internal/static_assert.h
deque.$(OBJEXT): $(top_srcdir)/internal/vm.h
deque.$(OBJEXT): $(top_srcdir)/internal/warnings.h
deque.$(OBJEXT): {$(VPATH)}deque.c
deque.$(OBJEXT): {$(VPATH)}assert.h
deque.$(OBJEXT): {$(VPATH)}backward/2/assume.h
deque.$(OBJEXT): {$(VPATH)}backward/2/attributes.h
deque.$(OBJEXT): {$(VPATH)}backward/2/bool.h
deque.$(OBJEXT): {$(VPATH)}backward/2/extern.h
deque.$(OBJEXT): {$(VPATH)}backward/2/gcc_version_since.h
deque.$(OBJEXT): {$(VPATH)}backward/2/inttypes.h
deque.$(OBJEXT): {$(VPATH)}backward/2/limits.h
deque.$(OBJEXT): {$(VPATH)}backward/2/long_long.h
deque.$(OBJEXT): {$(VPATH)}backward/2/r_cast.h
deque.$(OBJEXT): {$(VPATH)}backward/2/rmodule.h
deque.$(OBJEXT): {$(VPATH)}backward/2/stdalign.h
deque.$(OBJEXT): {$(VPATH)}backward/2/stdarg.h
deque.$(OBJEXT): {$(VPATH)}builtin.h
deque.$(OBJEXT): {$(VPATH)}config.h
deque.$(OBJEXT): {$(VPATH)}debug_counter.h
deque.$(OBJEXT): {$(VPATH)}defines.h
deque.$(OBJEXT): {$(VPATH)}encoding.h
deque.$(OBJEXT): {$(VPATH)}intern.h
deque.$(OBJEXT): {$(VPATH)}internal.h
deque.$(OBJEXT): {$(VPATH)}internal/anyargs.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/char.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/double.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/fixnum.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/gid_t.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/int.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/intptr_t.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/long.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/long_long.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/mode_t.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/off_t.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/pid_t.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/short.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/size_t.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/st_data_t.h
deque.$(OBJEXT): {$(VPATH)}internal/arithmetic/uid_t.h
deque.$(OBJEXT): {$(VPATH)}internal/assume.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/alloc_size.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/artificial.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/cold.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/const.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/constexpr.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/deprecated.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/diagnose_if.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/enum_extensibility.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/error.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/flag_enum.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/forceinline.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/format.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/maybe_unused.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/noalias.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/nodiscard.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/noexcept.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/noinline.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/nonnull.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/noreturn.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/pure.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/restrict.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/returns_nonnull.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/warning.h
deque.$(OBJEXT): {$(VPATH)}internal/attr/weakref.h
deque.$(OBJEXT): {$(VPATH)}internal/cast.h
deque.$(OBJEXT): {$(VPATH)}internal/compiler_is.h
deque.$(OBJEXT): {$(VPATH)}internal/compiler_is/apple.h
deque.$(OBJEXT): {$(VPATH)}internal/compiler_is/clang.h
deque.$(OBJEXT): {$(VPATH)}internal/compiler_is/gcc.h
deque.$(OBJEXT): {$(VPATH)}internal/compiler_is/intel.h
deque.$(OBJEXT): {$(VPATH)}internal/compiler_is/msvc.h
deque.$(OBJEXT): {$(VPATH)}internal/compiler_is/sunpro.h
deque.$(OBJEXT): {$(VPATH)}internal/compiler_since.h
deque.$(OBJEXT): {$(VPATH)}internal/config.h
deque.$(OBJEXT): {$(VPATH)}internal/constant_p.h
deque.$(OBJEXT): {$(VPATH)}internal/core.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rarray.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rbasic.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rbignum.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rclass.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rdata.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rfile.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rhash.h
deque.$(OBJEXT): {$(VPATH)}internal/core/robject.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rregexp.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rstring.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rstruct.h
deque.$(OBJEXT): {$(VPATH)}internal/core/rtypeddata.h
deque.$(OBJEXT): {$(VPATH)}internal/ctype.h
deque.$(OBJEXT): {$(VPATH)}internal/dllexport.h
deque.$(OBJEXT): {$(VPATH)}internal/dosish.h
deque.$(OBJEXT): {$(VPATH)}internal/error.h
deque.$(OBJEXT): {$(VPATH)}internal/eval.h
deque.$(OBJEXT): {$(VPATH)}internal/event.h
deque.$(OBJEXT): {$(VPATH)}internal/fl_type.h
deque.$(OBJEXT): {$(VPATH)}internal/gc.h
deque.$(OBJEXT): {$(VPATH)}internal/glob.h
deque.$(OBJEXT): {$(VPATH)}internal/globals.h
deque.$(OBJEXT): {$(VPATH)}internal/has/attribute.h
deque.$(OBJEXT): {$(VPATH)}internal/has/builtin.h
deque.$(OBJEXT): {$(VPATH)}internal/has/c_attribute.h
deque.$(OBJEXT): {$(VPATH)}internal/has/cpp_attribute.h
deque.$(OBJEXT): {$(VPATH)}internal/has/declspec_attribute.h
deque.$(OBJEXT): {$(VPATH)}internal/has/extension.h
deque.$(OBJEXT): {$(VPATH)}internal/has/feature.h
deque.$(OBJEXT): {$(VPATH)}internal/has/warning.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/array.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/bignum.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/class.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/compar.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/complex.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/cont.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/dir.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/enum.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/enumerator.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/error.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/eval.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/file.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/gc.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/hash.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/io.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/load.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/marshal.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/numeric.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/object.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/parse.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/proc.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/process.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/random.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/range.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/rational.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/re.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/ruby.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/select.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/select/largesize.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/signal.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/sprintf.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/string.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/struct.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/thread.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/time.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/variable.h
deque.$(OBJEXT): {$(VPATH)}internal/intern/vm.h
deque.$(OBJEXT): {$(VPATH)}internal/interpreter.h
deque.$(OBJEXT): {$(VPATH)}internal/iterator.h
deque.$(OBJEXT): {$(VPATH)}internal/memory.h
deque.$(OBJEXT): {$(VPATH)}internal/method.h
deque.$(OBJEXT): {$(VPATH)}internal/module.h
deque.$(OBJEXT): {$(VPATH)}internal/newobj.h
deque.$(OBJEXT): {$(VPATH)}internal/rgengc.h
deque.$(OBJEXT): {$(VPATH)}internal/scan_args.h
deque.$(OBJEXT): {$(VPATH)}internal/special_consts.h
deque.$(OBJEXT): {$(VPATH)}internal/static_assert.h
deque.$(OBJEXT): {$(VPATH)}internal/stdalign.h
deque.$(OBJEXT): {$(VPATH)}internal/stdbool.h
deque.$(OBJEXT): {$(VPATH)}internal/symbol.h
deque.$(OBJEXT): {$(VPATH)}internal/token_paste.h
deque.$(OBJEXT): {$(VPATH)}internal/value.h
deque.$(OBJEXT): {$(VPATH)}internal/value_type.h
deque.$(OBJEXT): {$(VPATH)}internal/variable.h
deque.$(OBJEXT): {$(VPATH)}internal/warning_push.h
deque.$(OBJEXT): {$(VPATH)}internal/xmalloc.h
deque.$(OBJEXT): {$(VPATH)}missing.h
deque.$(OBJEXT): {$(VPATH)}onigmo.h
deque.$(OBJEXT): {$(VPATH)}oniguruma.h
deque.$(OBJEXT): {$(VPATH)}ruby_assert.h
deque.$(OBJEXT): {$(VPATH)}st.h
deque.$(OBJEXT): {$(VPATH)}subst.h
deque.$(OBJEXT): {$(VPATH)}transient_heap.h
deque.$(OBJEXT): {$(VPATH)}util.h
